...
namespace backend.Controllers
{
    public class VNPayController : Controller
    {
        ...
        public string returnUrl = "https://localhost:7006/VNpayAPI/paymentConfirm";
        //public string returnUrl = "https://cnweb.onrender.com/VNpayAPI/paymentConfirm"
        ...
        [HttpGet("/VNPayAPI/{amount}&{infor}&{orderinfor}")]
        ...
        [HttpGet("/VNpayAPI/paymentconfirm")]
