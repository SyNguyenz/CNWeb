        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayDat = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenHangHoa = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    LoaiHangHoa = table.Column<string>(type: "text", nullable: false),
                    HangSanXuat = table.Column<string>(type: "text", nullable: false),
                    ThongTin = table.Column<string>(type: "text", nullable: false),
                    ThongSo = table.Column<string>(type: "text", nullable: false),
                    Gia = table.Column<double>(type: "double precision", nullable: false),
                    Star5 = table.Column<int>(type: "integer", nullable: false),
                    Star4 = table.Column<int>(type: "integer", nullable: false),
                    Star3 = table.Column<int>(type: "integer", nullable: false),
                    Star2 = table.Column<int>(type: "integer", nullable: false),
                    Star1 = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
