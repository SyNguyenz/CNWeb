...
namespace backend.Migrations
{
    ...
    [Migration("20240520131154_updateVariant")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Data.Variant", b =>
                {
                    b.Property<Guid>("MaHangHoa")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Data.Variant", b =>
                {
                    ...
                    b.HasOne("backend.Data.VariantModel", "VariantModel")
                        .WithMany("Variants")
                        .HasForeignKey("VariantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Variant_VariantModel");

                    b.Navigation("HangHoa");

                    b.Navigation("VariantModel");
                });
